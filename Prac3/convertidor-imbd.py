...
with open('fitxersDadesAnalisi/media_score_imbd_por_pais.json', 'r') as file:
    data = json.load(file)
...
for entry in data:
    ...
    if best_match:
        structured_data[best_match] = {
            "media_score_imbd": entry['media_score_imbd'],
        }
...
with open('updated_countries_imbd.geojson', 'w') as file:
